"""
Versión compatible del backend sin campos fecha_creacion y fecha_actualizacion.
Este archivo es una versión modificada de app.py que elimina la dependencia
de las columnas que no existen en la base de datos de producción.
"""
...
class Producto(db.Model):
    ...
    # NOTA: Se han eliminado las columnas que causaban el error:
...
with app.app_context():
    try:
        ...
        # Este import está comentado porque depende de módulos que quizás no tenemos acceso aquí
